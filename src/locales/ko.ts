...
export const translations = {
  "nativeName": "한국어",
  "flag": "🇰🇷",
  "aboutDesc": "Ultra Steem Editor — Web Crypto (AES-GCM) 보안, 이중 암호화 및 PIN 보호 기능을 갖춘 Steem 전용 고성능 에디터입니다.",
  "aboutApp": "앱 정보",
  "packagesUsed": "사용된 패키지 (NPM)",
  "credits": "저작권 및 개발",
  "aiCredits": "AI (Gemini AI)",
  "humanCredits": "인간 (기획/테스터)",
  "aiTasks": "코드 작성, 기술 최적화, 비즈니스 로직 구현",
  "humanTasks": "아이디어, 창의적 방향 제시, 테스트 및 피드백",
  "developer": "개발자",
  "license": "라이선스",
  "editor": "에디터",
  "preview": "미리보기",
