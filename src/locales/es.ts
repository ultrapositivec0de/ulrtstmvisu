...
export const translations = {
  "nativeName": "Español",
  "flag": "🇪🇸",
  "aboutDesc": "Ultra Steem Editor — editor profesional multiproceso para Steem con seguridad Web Crypto (AES-GCM), doble cifrado y protección PIN.",
  "aboutApp": "Acerca de la App",
  "packagesUsed": "Paquetes Usados (NPM)",
  "credits": "Autoría y Desarrollo",
  "aiCredits": "IA (Gemini AI)",
  "humanCredits": "Humano",
  "aiTasks": "Escritura de código, optimización técnica, implementación lógica",
  "humanTasks": "Idea, dirección creativa, pruebas, asistencia",
